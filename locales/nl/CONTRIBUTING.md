...
### 3. Word lid van de ProGenTeam-community
...
- **Bestaande issues controleren:** Zoek in [GitHub Issues](https://github.com/ACS-UI/Roo-Code/issues).
...
- Voor documentatie, bezoek [ProGenTeam Docs](https://github.com/ACS-UI/Roo-Code-Docs).

### Bugs of problemen melden

- Controleer eerst of er al meldingen zijn.
- Maak nieuwe bugmeldingen met de ["Bug Report"-template](https://github.com/ACS-UI/Roo-Code/issues/new/choose).
- **Beveiligingsproblemen:** Meld privé via [security advisories](https://github.com/ACS-UI/Roo-Code/security/advisories/new).
...
Door een pull request in te dienen, ga je ermee akkoord dat je bijdragen worden gelicenseerd onder de Apache 2.0-licentie, in overeenstemming met de licentie van ProGenTeam.
