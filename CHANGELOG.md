...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the ProGenTeam settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause ProGenTeam to hang, particularly in orchestrator mode
...
- Simplify and streamline ProGenTeam's quick actions
- Allow ProGenTeam settings to be imported from the welcome screen (thanks @julionav)
...
- Focus ProGenTeam in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus ProGenTeam input field (thanks @axkirillov!)
...
- Allow processes to access the ProGenTeam API via a unix socket
...
- Add an activation command that other extensions can use to interface with ProGenTeam (thanks @gtaylor!)
...
- Internationalize ProGenTeam into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Add opt-in telemetry to help us improve ProGenTeam faster (thanks Cline!)
...
- Add support for a .rooignore to prevent ProGenTeam from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into ProGenTeam (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](https://github.com/ACS-UI/Roo-Code/issues/1173))
...
- Introducing ProGenTeam 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New ProGenTeam community Discord at https://roocode.com/discord!
...
- **Name Change From Roo Cline to ProGenTeam:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to ProGenTeam to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for ProGenTeam! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
- This release adds chat modes! Now you can ask ProGenTeam questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new ProGenTeam Reddit! https://www.reddit.com/r/RooCode
...
- Incorporate Premshay's [PR](https://github.com/ACS-UI/Roo-Code/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/ACS-UI/Roo-Code/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/ACS-UI/Roo-Code/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/ACS-UI/Roo-Code/pull/42) to add support for OpenRouter compression
